<?php
		...
		}public function edit($id)
		{
			...
			$this->data['slider'] = $this->Slider_model->get_row_single('slider',array('sliderID'=>$id));$this->load->template('admin/slider/edit',$this->data);
		}
		...
		public function update()
		{
			...
			$data = $this->input->post();
			$id = $data['sliderID'];
			unset($data['sliderID']);$config['upload_path']          = './uploads/';
					                $config['allowed_types']        = 'jpg|png.gif|mp4';
					                $config['max_size']             = 5000;
					                $config['max_width']            = 5024;
					                $config['max_height']           = 4768;
					                ...
					                $id = $this->Slider_model->update('slider',$data,array('sliderID'=>$id));
			if ($id) {
				redirect('admin/slider');
			}
		}public function delete($id)
		{
			...
			$this->Slider_model->delete('slider',array('sliderID'=>$id));
			redirect('admin/slider');
		}}