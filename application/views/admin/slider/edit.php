...
<div id="page-wrapper">
    ...
    <div class="content">
        ...
        <form method="post" action="<?php echo base_url() ?>admin/slider/update" enctype="multipart/form-data">
            <input type="hidden" name="sliderID" value="<?php echo $slider["sliderID"] ?>">
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-bd ">
                        ...
                        <div class="panel-body"><div class="form-group row">
                                ...
                                <label for="example-text-input" class="col-sm-3 col-form-label">Name<span class="required">*</span></label>
                                        ...
                                        <input class="form-control" name="Name" type="text" value="<?php echo $slider["Name"] ?>" id="example-text-input" placeholder="" required=""></div>
