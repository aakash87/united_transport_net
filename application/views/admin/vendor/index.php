										    ...
										    <tbody>
												...
												<tr>
													...
													<td>
														...
														?>
														<a href="<?php echo base_url() ?>admin/vendor/edit/<?php echo $module["id"] ?>"><img src="<?php echo base_url() ?>assets/record1.png" title="View Order" alt="View Order" width="35" height="35"></a>
														<?php } ?>
														<?php 
