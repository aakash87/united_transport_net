							...
							<div class="panel panel-bd">
								<div class="panel-heading">
									<div class="panel-title">
										...
										?>
										<a href="<?php echo base_url("admin/customer/create") ?>"><button class="btn btn-info pull-right">Add Customer</button></a>
										<?php } ?>
									</div>
								</div>
										    ...
										    <tbody>
												...
												<tr>
													...
													<td>
														...
														?>
														<a href="<?php echo base_url() ?>admin/customer/edit/<?php echo $module["id"] ?>"><img src="<?php echo base_url() ?>assets/record1.png" title="View Order" alt="View Order" width="35" height="35"></a>
														<?php } ?>
														<?php 
