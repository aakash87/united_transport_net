<div id="page-wrapper" style="min-height: 543px;">
    ...
    <div class="content">
        ...
        <div class="row">
         ...
         <!--     <a href="<?php //echo base_url(); ?>"><div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                <div class="statistic-box statistic-filled-3 border" style=" box-shadow: 10px 10px 5px #888888;">
            ...
            <a href="<?php echo base_url(); ?>/admin/reports/vehicle_ledger"><div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
             ...
             <!-- <a href="<?php echo base_url(); ?>/admin/drivers/driver_ledger"><div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                <div class="statistic-box statistic-filled-3 border" style=" box-shadow: 10px 10px 5px #888888;">
                    <h2><span class="slight">Drivers LEDGER</span></h2>
                    <div class="small"></div>
                    <i class="ti-notepad statistic_icon"></i>
