...
<div id="page-wrapper">
    ...
    <div class="content">
        ...
        <form method="post" action="<?php echo base_url() ?>admin/bank/insert" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-bd ">
                        ...
                        <div class="panel-body"><div class="form-group row">
                                ...
                                <label for="example-text-input" class="col-sm-3 col-form-label">Bank name</label>
                                        <div class="col-sm-9"><input class="form-control" name="bank_name" type="text" value="" id="example-text-input" placeholder="" ></div>
