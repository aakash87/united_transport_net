                ...
                <div class="row align-items-stretch justify-content-center">
                    ...
                    <div class="col-12 mt-4">
                        <div class="background-white p-5 h-100 radius-secondary">
                            ...
                            <form class="zform mt-3">
                                <div class="row">
                                    <div class="col-12"><input class="form-control" type="hidden" name="to" value="user@domain.extension"><input class="form-control background-white" type="text" placeholder="Your Name" required></div>
                                    <div class="col-12 mt-4"><input class="form-control background-white" type="email" placeholder="Email" required></div>
                                    <div class="col-12 mt-4"><textarea class="form-control background-white" rows="11" placeholder="Enter your descriptions here..." required></textarea></div>
                                    <div class="col-12 mt-4">
                                        <div class="row">
                                            <div class="col-auto"><button class="btn btn-md-lg btn-primary" type="Submit"> <span class="color-white fw-600">Send Now</span></button></div>
                                            <div class="col">
                    ...
                    <div class="col-12 mt-4">
                        <div class="background-white p-5 radius-secondary">
                            <div class="googlemap" data-latlng="24.8607 , 67.0011" data-scrollwheel="false" data-icon="<?php echo base_url() ?>front_assets/images/map-marker.png" data-zoom="5" >
