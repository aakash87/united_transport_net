                    ...
                    <div class="row pt-6" data-inertia='{"weight":1.5}'>
                        <div class="col-md-8 px-md-0 color-white" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                            <div class="overflow-hidden">
                                <h1 class="color-white fs-4 fs-md-5 mb-0 zopacity" data-zanim='{"delay":0}'>Services</h1>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 pr-0 pr-lg-3"><img class="radius-secondary" src="<?php echo base_url() ?>front_assets/images/why-choose-us.jpg" alt="" /></div>
            ...
            <div class="container">
                ...
                <div class="row no-gutters pos-relative mt-6">
                    ...
                    <div class="col-lg-6 py-3 py-lg-0 mb-0" style="min-height:400px;">
                        <div class="background-holder radius-tl-secondary radius-tr-secondary radius-tr-lg-0" style="background-image:url(<?php echo base_url() ?>front_assets/images/6.jpg);"></div>
                        <!--/.background-holder-->
                    </div>
                ...
                <div class="row no-gutters pos-relative mt-4 mt-lg-0">
                    ...
                    <div class="col-lg-6 py-3 py-lg-0 mb-0 order-lg-2" style="min-height:400px;">
                        <div class="background-holder radius-tl-secondary radius-tl-lg-0 radius-tr-secondary radius-tr-lg-0" style="background-image:url(<?php echo base_url() ?>front_assets/images/7.jpg);"></div>
                        <!--/.background-holder-->
                    </div>
                ...
                <div class="row no-gutters pos-relative mt-4 mt-lg-0">
                    <div class="elixir-caret d-none d-lg-block"></div>
                    <div class="col-lg-6 py-3 py-lg-0 mb-0" style="min-height:400px;">
                        <div class="background-holder radius-tl-secondary radius-tr-secondary radius-tr-lg-0 radius-tl-lg-0 radius-bl-0 radius-bl-lg-secondary" style="background-image:url(<?php echo base_url() ?>front_assets/images/8.jpg);"></div>
                        <!--/.background-holder-->
                    </div>
                    ...
                    <div class="col">
                        <div class="owl-carousel owl-theme owl-dot-round" data-options='{"nav":true,"dots":false,"loop":true,"autoplay":true,"autoplayHoverPause":true,"items":1}'>
                            <div class="row px-lg-8">
                                <div class="col-4 col-md-3 mx-auto"><img class="radius-secondary mx-auto" src="<?php echo base_url() ?>front_assets/images/client1.png" alt="Member" style="width: auto;" /></div>
                            ...
                            <div class="row px-lg-8">
                                <div class="col-4 col-md-3 mx-auto"><img class="radius-secondary mx-auto" src="<?php echo base_url() ?>front_assets/images/client2.png" alt="Member" style="width: auto;" /></div>
                                <div class="col-md-9 ml-auto mt-4 mt-md-0 px-4 px-sm-3">
                            ...
                            <div class="row px-lg-8">
                                <div class="col-4 col-md-3 mx-auto"><img class="radius-secondary mx-auto" src="<?php echo base_url() ?>front_assets/images/client3.png" alt="Member" style="width: auto;" /></div>
                                <div class="col-md-9 ml-auto mt-4 mt-md-0 px-4 px-sm-3">
        ...
        <section class="background-10 py-6">
            <div class="container">
                <div class="row align-items-center" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="col-4 col-md-2 my-3 overflow-hidden"><img src="<?php echo base_url() ?>front_assets/images/partner/logo2.png" alt="" data-zanim="{}" /></div>
                    <div class="col-4 col-md-2 my-3 overflow-hidden"><img src="<?php echo base_url() ?>front_assets/images/partner/logo1.png" alt="" data-zanim="{}" /></div>
                    <div class="col-4 col-md-2 my-3 overflow-hidden"><img src="<?php echo base_url() ?>front_assets/images/partner/logo6.png" alt="" data-zanim="{}" /></div>
                    <div class="col-4 col-md-2 my-3 overflow-hidden"><img src="<?php echo base_url() ?>front_assets/images/partner/logo3.png" alt="" data-zanim="{}" /></div>
                    <div class="col-4 col-md-2 my-3 overflow-hidden"><img src="<?php echo base_url() ?>front_assets/images/partner/logo5.png" alt="" data-zanim="{}" /></div>
                    <div class="col-4 col-md-2 my-3 overflow-hidden"><img src="<?php echo base_url() ?>front_assets/images/partner/logo4.png" alt="" data-zanim="{}" /></div>
                </div>
                <!--/.row-->
            </div>
            <!--/.container-->
